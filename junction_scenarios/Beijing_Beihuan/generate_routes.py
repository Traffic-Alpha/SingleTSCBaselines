...
traffic_flow_configs = {
    ...
    "low_density": {
        '157863208#0.1590': [11, 10, 11, 10, 10],
        '252712271#0.589': [8, 8, 8, 8, 8],
        '-1106233488.150': [10, 10, 10, 10, 10]
    },
    
    # 2. 波动通勤车流 (Fluctuating Commuter Flow)
    "fluctuating_commuter": {
        '157863208#0.1590': [23, 19, 16, 12, 8],  # 早高峰
        '252712271#0.589': [9, 12, 16, 20, 23],  # 晚高峰
        '-1106233488.150': [9, 13, 20, 13, 9]  # 中段峰值
    },
    
    # 3. 饱和高密度车流 (Saturated High-Density Flow)
    "high_density": {
        '157863208#0.1590': [19, 18, 19, 18, 19],
        '252712271#0.589': [16, 16, 16, 16, 16],
        '-1106233488.150': [18, 18, 18, 18, 18]
    },
    
    # 4. 随机扰动车流 (Random Perturbation Flow)
    "random_perturbation": {
        '157863208#0.1590': [30, 14, 13, 13, 13],
        '252712271#0.589': [13, 13, 29, 13, 12],
        '-1106233488.150': [11, 11, 10, 10, 23]
    },
    
    # 5. 递增需求车流 (Increasing Demand Flow)
    "increasing_demand": {
        '157863208#0.1590': [7, 10, 13, 16, 19],  # 稳步增长
        '252712271#0.589': [9, 11, 12, 13, 15],  # 缓慢增长
        '-1106233488.150': [6, 7, 10, 17, 25]  # 后期加速
    },
}
