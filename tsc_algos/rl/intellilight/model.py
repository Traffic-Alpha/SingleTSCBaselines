...
@Description: IntelliLight movement-matrix feature extractor
...
class IntelliLightMovementModel(BaseFeaturesExtractor):
    ...
    def __init__(
        ...
        if len(observation_space.shape) != 3:
            raise ValueError(
                f"IntelliLightMovementModel expects 3D observations, got {observation_space.shape}."
            )
